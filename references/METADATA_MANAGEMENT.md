...
> **Cubes Management**: Detailed cube CRUD operations (create, read, update, delete, rules management) are covered in `METADATA_MANAGEMENT_ADVANCED.md` due to length constraints.
...
For advanced patterns, see `METADATA_MANAGEMENT_ADVANCED.md`.  
